        ...
        <div className='max-w-screen-xl mx-auto px-4 w-full py-10 md:py-16'>
            <div className='grid md:grid-cols-3 gap-7'>
                <div>
                    ...
                    <Image src="/logo-hotel.jpg" alt="logo" width={128} height={49}/>
                    </Link>
                    <p className="text-gray-400">
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Animi, perspiciatis repellat praesentium odit iure aperiam?
                    </p>
                </div>
